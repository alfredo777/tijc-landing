    ...
    const Modals = {
        ...
        infoData: {
            sede: {
                ...
                content: '<p class="mb-4 text-gray-600">El torneo se realizará en las instalaciones de <strong class="text-gray-900">Altium Sports Complex</strong>, ubicado en Zapopan, Jalisco.</p><ul class="space-y-3 text-gray-600"><li class="flex items-start gap-3"><i class="fas fa-check text-rosa mt-1"></i><span>Canchas de pasto sintético profesional</span></li><li class="flex items-start gap-3"><i class="fas fa-check text-rosa mt-1"></i><span>Control de acceso a instalaciones para jugadores y familiares</span></li><li class="flex items-start gap-3"><i class="fas fa-check text-rosa mt-1"></i><span>Vestidores equipados</span></li><li class="flex items-start gap-3"><i class="fas fa-check text-rosa mt-1"></i><span>Área de alimentos y bebidas</span></li><li class="flex items-start gap-3"><i class="fas fa-check text-rosa mt-1"></i><span>Estacionamiento amplio y seguro</span></li></ul>'
            },
            fechas: {
                icon: 'fa-calendar-alt',
                title: 'Fechas del Torneo',
                content: '<p class="mb-4 text-gray-600">El Torneo Jorge Campos 2026 se llevará a cabo del <strong class="text-gray-900">12 al 16 de Noviembre de 2026</strong>.</p><ul class="space-y-3 text-gray-600"><li class="flex items-start gap-3"><i class="fas fa-calendar-day text-dorado-dark mt-1"></i><span><strong>12 Nov:</strong> Junta Previa para entrenadores</span></li><li class="flex items-start gap-3"><i class="fas fa-calendar-day text-dorado-dark mt-1"></i><span><strong>13 Nov:</strong> Inauguración y Fase de Grupos</span></li><li class="flex items-start gap-3"><i class="fas fa-calendar-day text-dorado-dark mt-1"></i><span><strong>14 Nov:</strong> Fase de Grupos</span></li><li class="flex items-start gap-3"><i class="fas fa-calendar-day text-dorado-dark mt-1"></i><span><strong>15 Nov:</strong> Etapas Eliminación Directa y Finales Copa Plata</span></li><li class="flex items-start gap-3"><i class="fas fa-calendar-day text-dorado-dark mt-1"></i><span><strong>16 Nov:</strong> Finales y Premiación</span></li></ul>'
            },
            jugadores: {
                icon: 'fa-users',
        ...
        expData: {
            ...
            viaje: {
                ...
                subtitle: 'Séptimo Cielo Travel',
                content: '<p class="mb-4 text-gray-600"><strong class="text-gray-900">Séptimo Cielo Travel</strong> te ayuda a personalizar tu viaje para que vivas la mejor experiencia en el Torneo Jorge Campos 2026.</p><div class="bg-gradient-to-r from-morado/10 to-rosa/10 rounded-xl p-4 mb-4"><p class="text-center text-gray-700 font-semibold mb-2">¡Déjanos organizar todo por ti!</p></div><ul class="space-y-3 text-gray-600"><li class="flex items-start gap-3"><i class="fas fa-hotel text-dorado-dark mt-1"></i><span>Hospedaje cerca de las sedes</span></li><li class="flex items-start gap-3"><i class="fas fa-plane-departure text-dorado-dark mt-1"></i><span>Vuelos y traslados</span></li><li class="flex items-start gap-3"><i class="fas fa-map-marked-alt text-dorado-dark mt-1"></i><span>Paquetes todo incluido</span></li><li class="flex items-start gap-3"><i class="fas fa-concierge-bell text-dorado-dark mt-1"></i><span>Atención personalizada</span></li></ul><div class="mt-6 pt-4 border-t border-gray-200"><p class="font-bold text-gray-900 mb-3"><i class="fas fa-address-card text-rosa mr-2"></i>Contacto:</p><div class="space-y-2"><p class="flex items-center gap-2 text-gray-600"><i class="fas fa-user text-morado"></i><span><strong>Gustavo Hernández</strong></span></p><p class="flex items-center gap-2 text-gray-600"><i class="fas fa-phone text-morado"></i><a href="tel:+529993185679" class="hover:text-rosa transition-colors">999 318 5679</a></p><p class="flex items-center gap-2 text-gray-600"><i class="fas fa-envelope text-morado"></i><a href="mailto:Ventas@septimocielotravel.com" class="hover:text-rosa transition-colors">Ventas@septimocielotravel.com</a></p></div><a href="https://wa.me/529993185679?text=Hola,%20me%20interesa%20información%20sobre%20paquetes%20de%20viaje%20para%20el%20Torneo%20Jorge%20Campos%202026" target="_blank" class="mt-4 w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors"><i class="fab fa-whatsapp text-xl"></i>Contactar por WhatsApp</a></div>'
            }
        },
